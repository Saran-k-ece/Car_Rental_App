    ...
    {[benz1, benz2, benz3, benz4, benz5].map((image, index) => (
      ...
      <div className="max-w-8xl mx-auto p-9">
        ...
        <p className="text-gray-700">
           Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia cum ipsa fuga? At, vero quasi? Atque suscipit maiores, dolore rem temporibus qui voluptatibus eaque odit tempore sit deserunt consequatur fugit consequuntur deleniti accusamus fuga, quisquam, labore ut ea aut inventore! Voluptatibus quaerat et amet incidunt laudantium quos magnam hic necessitatibus. Esse non, ea placeat magnam repellat voluptates fugit assumenda. A tempora quis harum officiis veritatis in iusto dicta excepturi, hic deleniti quod rerum, doloremque aliquam ipsum ab, facilis quaerat nesciunt odit sit. Similique, beatae? Non fuga quia fugiat unde, eos reprehenderit asperiores harum doloribus et, recusandae laborum, perferendis placeat sunt.
        </p>
      </div>
